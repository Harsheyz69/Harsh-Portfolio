...
const SkillPill = ({ skill, index, variant = "primary" }) => {
    ...
    const baseClasses = "group relative px-6 py-4 rounded-2xl font-medium text-base shadow-lg border backdrop-blur-sm flex items-center gap-3 flex-shrink-0 transition-all duration-300 cursor-pointer";

    const variantClasses = variant === "primary"
        ? "bg-white/90 dark:bg-gray-800/90 text-gray-800 dark:text-gray-200 border-gray-200/50 dark:border-gray-700/50 hover:shadow-xl hover:shadow-blue-500/20 dark:hover:shadow-blue-400/20 hover:border-blue-300/50 dark:hover:border-blue-500/50 hover:-translate-y-1"
...
const MarqueeRow = ({ items, direction = "left", duration = 30, variant = "primary" }) => {
    ...
    return (
        ...
        >
            ...
            <div className="absolute left-0 top-0 bottom-0 w-32 bg-gradient-to-r from-gray-50 dark:from-gray-900/50 to-transparent z-10 pointer-events-none" />
            <div className="absolute right-0 top-0 bottom-0 w-32 bg-gradient-to-l from-gray-50 dark:from-gray-900/50 to-transparent z-10 pointer-events-none" />
    ...
    return (
        <Section id="skills" title="Technical Skills" className="bg-gray-50 dark:bg-gray-900/50 overflow-hidden">
            <div className="relative w-full space-y-10">
                ...
                >
                    <h3 className="text-2xl font-bold text-center bg-gradient-to-r from-gray-700 to-gray-600 dark:from-gray-300 dark:to-gray-400 bg-clip-text text-transparent">
                        Languages
                    </h3>
                ...
                >
                    <h3 className="text-2xl font-bold text-center bg-gradient-to-r from-blue-600 to-purple-600 dark:from-blue-400 dark:to-purple-400 bg-clip-text text-transparent">
                        Frameworks & Tools
                    </h3>
